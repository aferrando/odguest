...
@interface RootViewController : UIViewController <CollapseViewControllerDelegate, LoginViewControllerDelegate, RegisterViewControllerllerDelegate, InstantDealViewControllerDelegate, FBSessionDelegate > {
    UIView * liveBar;
