...
- (id)initWithFrame:(CGRect)frame type:(int) type
{
    ...
    if (self) {
        ...
        switch (type) {
            case 1:
                self.backgroundImage = [UIImage imageNamed:@"bg-green.png"];
...
{
    return [YRDropdownView showDropdownInView:view title:title detail:detail image:nil animated:animated hideAfter:0.0 type:0];
}
...
{
    return [YRDropdownView showDropdownInView:view title:title detail:detail image:image animated:animated hideAfter:0.0 type:0];
}
                             ...
                             type:(int)type
{
    ...
    YRDropdownView *dropdown = [[YRDropdownView alloc] initWithFrame:CGRectMake(0, 0, view.bounds.size.width, 44) type:type ];
